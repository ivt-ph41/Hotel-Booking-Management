                        ...
                        <!-- select -->
                            <div class="form-group">
                                ...
                                <select name="person_room_id" class="custom-select">
                                    @foreach($person_rooms as $person_room)
                                        <option {{$room->person_room_id == $person_room->id ? 'selected' : null}}
                                                value="{{$person_room->id}}">{{$person_room->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <!-- select -->
                            <div class="form-group">
                                ...
                                <select name="bed_id" class="custom-select">
                                    @foreach($beds as $bed)
                                        <option {{$room->bed_id == $bed->id ? 'selected' : null}}
                            ...
                            <div class="form-group">
                                ...
                                <select name="type_id" class="custom-select">
                                    @foreach($types as $type)
                                        <option {{$room->type_id == $type->id ? 'selected' : null}}
