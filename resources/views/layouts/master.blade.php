            ...
            <div class="header__top__right">
              <div class="header__top__auth">
                ...
                <form action="{{ route('logout') }}" method="post">
                  ...
                  @csrf
                  <button style="border: solid #e9ad28; background-color: #e9ad28;" type="submit">Logout
                  </button>
                </form>
        ...
        <div class="row">
          <div class="col-lg-2">
            <div class="header__logo">
              <a href="{{ route('/')}}"><img src="{{asset('hiroto-master/img/logo.png')}}" alt=""></a>
            </div>
          </div>
          <div class="col-lg-10">
            <div class="header__nav">
              ...
              <div class="header__nav__widget">
                <a href="{{route('admins.dashboards')}}">Go to Dashboard
